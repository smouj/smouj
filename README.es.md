<h1 align="center">smouj — Arquitecto de SuperAgentes Autónomos</h1>
...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=18&pause=1300&center=true&vCenter=true&width=980&lines=Construyendo+skills+m%C3%ADticas+de+IA+para+automatizaci%C3%B3n+real;Local-first+%E2%80%A2+Privacidad+primero+%E2%80%A2+Open-source+siempre;De+skills+individuales+a+SuperAgentes+coordinados" alt="Typing ticker" />
</p>
...
| 📈 | SLO Warden | [smouj/SLO-Warden](https://github.com/smouj/SLO-Warden) | Triaje de incidentes SLO burn-rate y playbooks de decisión rollback-first. | Iniciando | Media-Alta | Acelerador de respuesta a incidentes y fiabilidad |
...
## Proyectos Privados (sin enlace)

| Proyecto | Visibilidad | Descripción | Estado |
|---|---|---|---|
| FlickClaw SaaS | Privado | Plataforma SaaS de vídeo/contenido con IA | Activo |
| RPGCLAW | Privado | Plataforma RPG online y sistemas | Mantenimiento |

## Filosofía
- Local-first por diseño
- Privacidad primero
- Modelos abiertos por encima del lock-in
